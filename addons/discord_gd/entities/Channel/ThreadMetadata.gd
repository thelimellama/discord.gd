...
class_name ThreadMetadata extends Dataclass
...
var create_timestamp = null # [String] Timestamp when the thread was created; only populated for threads created after 2022-01-09
