...
var owner = null # PartialUser Partial user object containing info on the owner of the application
var summary: String # (deprecated) and will be removed in v11. An empty string.
...
var custom_install_url: String # The application's default custom authorization link, if enabled
