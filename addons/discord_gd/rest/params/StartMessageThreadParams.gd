# Params for start message thread
class_name StartMessageThreadParams extends Dataclass
...
# @hidden
func _init().("StartMessageThreadParams", {include_null_in_dict = false}): return self
